...
def check_section_line(section_one_range, section_two_range):
    res = 0
    # print("Test", section_one_range, section_two_range)
    ...
    elif section_one_range[0] == section_two_range[0] or section_one_range[-1] == section_two_range[-1] or section_one_range[0] == section_two_range[-1] or  section_one_range[-1] == section_two_range[0]:
        # print("Something", section_one_range, section_two_range)
        res = 1

    # From section two perspective
    elif (section_two_range[0] >= section_one_range[0] and section_two_range[0] <= section_one_range[-1])  and (section_two_range[-1] >= section_one_range[-1] and section_two_range[0] <= section_one_range[-1]):
        # print("Something 2: ", section_one_range, section_two_range)
        res = 1

    # From section one perspective
    elif (section_one_range[0] >= section_two_range[0] and section_one_range[0] <= section_two_range[-1])  and (section_one_range[-1] >= section_two_range[-1] and section_one_range[0] <= section_two_range[-1]):
        # print("Something 2: ", section_one_range, section_two_range)
        res = 1
...
print("Part 2: total value: ", total_value)
